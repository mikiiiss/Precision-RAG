...
from data_generator import get_completion,file_reader
...
if __name__ == "__main__":
    context_message = file_reader("/home/miki/Precision-RAG/prompts/context.txt")
    prompt_message = file_reader("/home/miki/Precision-RAG/prompts/data_evaluation.txt")
    ...
    file_path = os.path.join(base_dir, "/home/miki/Precision-RAG/test_dataset/test_data.json")
