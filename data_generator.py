...
def save_json(test_data):
    ...
    file_path = os.path.join(parent_directory,"/home/miki/Precision-RAG/test_dataset/test_data.json")
...
# Get the parent directory of the current script directory
    ...
    prompt = file_reader(os.path.join(parent_directory,"/home/miki/Precision-RAG/prompts/data_generation.txt"))
